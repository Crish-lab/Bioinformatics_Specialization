...
coder: Lo Kwongho
'''
#INPUT: Dos strings correspondientes a secuencias de aminoácidos en su forma alfabética pero de tamaños
# muy diferentes.
#OURPUT: el score del máximo alineamiento entre dichas secuencias usando como match +1;
# missmatch,insertion,deletion -1
#

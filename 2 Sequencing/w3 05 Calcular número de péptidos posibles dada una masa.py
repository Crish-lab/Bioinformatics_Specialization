# INPUT: un número entero correspondiente a la masa del péptido (m)
# OUPUT: un número entero correspondiente a la cantidad de péptidos que
# combinados satisfacen la masa.
# Correr el código y en la terminar ingresar el número correspondiente a
# 'm' y presionar enter

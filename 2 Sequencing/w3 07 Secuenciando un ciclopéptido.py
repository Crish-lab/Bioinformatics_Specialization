...
# En el documento de texto ingresar un espectro a partir del cual se pueden obtener
# una serie de integer masses correspondientes a las posibles secuencias de aminoácidos
# que satisfacen el espectro.
